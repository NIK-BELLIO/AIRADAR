...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="styles.css?v=v41" />
  ...
  <body>
    ...
    <div class="shell">
      <header class="topbar">
        ...
        <nav class="nav" aria-label="Primary navigation">
          ...
          <a href="#performance" data-i18n="navPerformance">Live charts</a>
          <a href="#mediaCaption" data-i18n="navMedia">Caption AI</a>
          <a href="#videoStudio" data-i18n="navStudio">Video studio</a>
          <a href="#intelligence" data-i18n="navIntelligence">Prompt lab</a>
        ...
        <div class="header-actions">
          ...
          <a class="button primary" href="#tools" data-i18n="startButton">Start</a>
        </div>
      </header>
        ...
        <section id="performance" class="panel performance-panel">
          <div class="section-head">
            ...
            <div style="display:flex;gap:10px;align-items:center;">
              <span id="liveIndicator" class="live-dot-wrap"><span class="live-dot"></span> Live</span>
              <button id="refreshChartBtn" class="button ghost" type="button">↻ Refresh</button>
            </div>
          </div>
          <div class="chart-tabs">
            <button class="chart-tab active" data-metric="stars">GitHub Stars</button>
            <button class="chart-tab" data-metric="forks">Forks</button>
            <button class="chart-tab" data-metric="activity">Dev Activity</button>
          </div>
            ...
            <div class="vstudio-controls">
              ...
              <div class="vstudio-block vtab-hidden" data-vtab-panel="format">
                ...
                <div class="control-grid">
                  ...
                  <label><span data-i18n="vDurationLabel">Duration (seconds)</span>
                    <input id="vsDuration" type="number" min="2" max="600" step="1" value="6" />
                  </label>
                </div>
                <div class="control-grid">
              ...
              <div class="vstudio-block vtab-hidden" data-vtab-panel="logo">
                ...
                <label><span data-i18n="vIntroLabel">Intro card text</span><input id="vsIntro" type="text" placeholder="AI Radar presents" /></label>
        ...
        <section id="about" class="panel about-panel">
          ...
          <div class="about-grid">
            <article class="credit-card">
              ...
              <p data-i18n="aboutCreditText">Designed and built AI Radar — concept, interface, and the video studio.</p>
            </article>
            <article class="credit-card">
              ...
              <p data-i18n="aboutProjectText">Runs entirely client-side. Live data from the public GitHub API; no tracking, no accounts.</p>
            </article>
          </div>
        </section>
    ...
    <script src="app.js?v=v41"></script>
  </body>
</html>
