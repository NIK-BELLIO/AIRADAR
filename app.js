...
.sidebar.collapsed .nav-ic { width: auto; }
...
.template-card strong { font-size: 13px; color: var(--text); }
.template-card small { font-size: 11px; color: var(--muted); line-height: 1.35; }
.template-swatch {
  height: 42px;
  border-radius: 6px;
  border: 1px solid;
