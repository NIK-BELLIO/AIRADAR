...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="styles.css?v=v276" />
    ...
    <style id="ar-extra">
      ...
      /* FEATURED TOOL */
      .ld-tod-body { flex: 1; display: flex; flex-direction: column; gap: 13px; }
      .ld-tod-top { display:flex; align-items:center; gap:14px; }
      .ld-tod-badge { width:56px; height:56px; border-radius:16px; display:flex; align-items:center; justify-content:center; font-family:Prata,serif; font-size:26px; color:#080808; background:linear-gradient(135deg,#F4D58D,#00D4FF); flex-shrink:0; box-shadow:0 8px 24px rgba(244,213,141,0.3); }
      ...
      .ld-tod-foot { margin-top:auto; font-size:11px; font-weight:700; color:#F4D58D; letter-spacing:.06em; }
      ...
      .ld-ticker-label { font-size: 11px; font-weight: 800; color: #080808; letter-spacing: .12em; white-space: nowrap; flex-shrink: 0; background: linear-gradient(90deg,#F4D58D,#00D4FF); padding: 6px 13px; border-radius: 7px; }
      ...
      /* ── AI STATUS MONITOR ───────────────────────────── */
      /* tool-of-day and AI map now stack full-width — no stretching */
      #toolOfDay.tod-panel { margin: 0 0 20px !important; }
      .ai-monitor { margin: 0 0 20px; }
      ...
      .aimap { position: relative; width: 100%; aspect-ratio: 2.6 / 1; max-height: 340px; }
      ...
      .aimap-hub-core { fill: #d8b76a; }
      .aimap-hub-ring { fill: none; stroke: #d8b76a; opacity: 0.7; transform-origin: center; }
      ...
      .ainews-list { display: grid; grid-template-columns: 1fr 1fr; gap: 8px; }
  ...
  <body>
    ...
    <div class="shell">
      ...
      <div class="content-area">
        ...
        <!-- TOOL OF THE DAY (full width, own row) -->
...
<div class="vs-auto-actions">
            ...
            <div style="display:flex;flex-direction:column;gap:12px;">
              ...
              <div style="border:1px solid var(--line);border-radius:10px;overflow:hidden;">
                <div style="display:flex;align-items:center;justify-content:space-between;padding:10px 14px;background:var(--surface-2);border-bottom:1px solid var(--line);">
                  ...
                  <span style="font-size:10px;font-weight:800;padding:2px 8px;border-radius:99px;background:rgba(216,183,106,0.15);border:1px solid rgba(216,183,106,0.3);color:var(--gold);">v2.4</span>
                </div>
      ...
      <div class="ld-nav">
        <div class="ld-nav-left">
          ...
          <div>
            ...
            <div class="ld-brand-sub" id="ldBrandSub">Real-Time Intelligence Center · v275</div>
          </div>
        </div>
    ...
    <script src="app.js?v=v276"></script>
